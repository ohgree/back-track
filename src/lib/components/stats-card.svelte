...
<div class="glass rounded-2xl p-6 border border-white/10">
  <h3 class="font-display text-sm font-semibold text-white/60 uppercase tracking-wider mb-4">
    {i18n.t("sessionStats")}
  </h3>
    ...
    <div class="flex-1 space-y-3">
      <div class="flex justify-between items-center">
        ...
        <span class="text-white font-mono text-sm"
          >{formatTime(postureStore.sessionStats.totalTime)}</span
        >
      </div>
      <div class="flex justify-between items-center">
        <span class="text-white/50 text-sm font-body">{i18n.t("goodPosture")}</span>
        <span class="text-back-400 font-mono text-sm"
          >{formatTime(postureStore.sessionStats.goodPostureTime)}</span
        >
      </div>
      <div class="flex justify-between items-center">
